        ...
        if GetLotNo = true then begin
            ...
            if ReservationEntry.Find('-') then
                repeat
                    TempExcelBuffer.NewRow();
                    TempExcelBuffer.AddColumn(PurchaseOrderLine."Document No.", false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
                    TempExcelBuffer.AddColumn(PurchaseOrderLine."Line No.", false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
                    TempExcelBuffer.AddColumn(PurchaseOrderLine."No.", false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
